class LineItem < ApplicationRecord
  ...
  validates_numericality_of :minimum_sample_size, greater_than: 0, less_than: 10000000, allow_blank: true,            if: Proc.new{ |li| li.specimen_request? && li.group.process_sample_size? }
